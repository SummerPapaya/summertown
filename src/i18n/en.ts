...
export const en = {
  ...
  apple: {
    ...
    close: 'Close',
    comments: {
      title: 'Orchard guest book',
      subtitle: 'leave the orchard a note — you can mention an apple you liked 🍎',
      nameLabel: 'Name',
      namePlaceholder: 'what should we call you?',
      emailLabel: 'Email',
      emailPlaceholder: 'you@example.com',
      emailHint: '(optional — never shown publicly)',
      bodyLabel: 'Message',
      bodyPlaceholder: 'this one looks wonderfully crisp…',
      ...
      loadMore: 'Read more notes',
      held: 'Got it! The town will take a look and pin it up 🍎',
      thanks: 'Pinned — thank you! 🍎',
      error: "couldn't pin your note — please try again",
      required: 'both a name and a message, please',
      badEmail: 'that email looks a little off',
      count: '{n} notes so far',
      ...
      expandReplies: 'show {n} more replies',
    ...
    admin: {
      ...
      syncNow: 'Sync now',
      syncing: 'Syncing…',
      syncHint: 'Pull the latest apples from Jike (also runs automatically at 23:00 daily)',
      syncDone: 'Synced — picked {n} new apple(s) 🍎',
      syncNone: 'No new apples — today is already in the basket 🍎',
      syncDetail: 'read {fetched} · matched {matched} · new {imported} · skipped {skipped}',
